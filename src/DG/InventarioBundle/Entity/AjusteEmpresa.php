 ...
 * AjusteEmpresa
 *
 * @ORM\Table(name="ajuste_empresa", indexes={@ORM\Index(name="fk_empresa_usuario_sistema1_idx", columns={"usuario_sistema_id"}), @ORM\Index(name="fk_empresa_time_zone1_idx", columns={"time_zone_id"}), @ORM\Index(name="fk_empresa_pais1_idx", columns={"pais_id"}), @ORM\Index(name="fk_empresa_idioma1_idx", columns={"idioma_id"})})
 * @ORM\Entity
 */
class AjusteEmpresa
{
