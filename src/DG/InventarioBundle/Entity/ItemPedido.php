 ...
 * ItemPedido
 *
 * @ORM\Table(name="item_pedido", indexes={@ORM\Index(name="fk_item_pedido_pedido1_idx", columns={"pedido_id"}), @ORM\Index(name="fk_item_pedido_producto1_idx", columns={"producto_id"})})
 * @ORM\Entity
 */
class ItemPedido
{
